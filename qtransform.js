	...
	***************************/
	...
	$.fn.jqTransCheckBox = function(){
		return this.each(function(){
			...
			if($.browser.msie) { oLabel && oLabel.click(function(){aLink.trigger('click');}); }
	...
	$.fn.jqTransSelect = function(){
		return this.each(function(index){
			...
			$ul.find('a').click(function(){
					...
					$ul.hide();
					$wrapper.removeClass('select-focus');
			...
			var oLinkOpen = $('a.jqTransformSelectOpen', $wrapper)
				.click(function(){
					...
					if( $ul.css('display') == 'none' ) {jqTransformHideSelect(); $wrapper.addClass('select-focus'); } 
...
{
 	if($('.jqTransformSelectWrapper ul:visible').length)
	{
		obj=$('.jqTransformSelectWrapper ul:visible');
		if(event.keyCode==27)
		{
			obj.hide();
		}
		...
		else if(event.keyCode==38)
		{
			...
			if(link.parent().prev().length)
			{
				...
				obj.animate({scrollTop: $('a.selected', obj).attr('index')*24});
			}
		}
		else
		{
